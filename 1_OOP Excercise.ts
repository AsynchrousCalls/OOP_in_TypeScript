...
class Square extends Shape{
   ...
   constructor(colour:string,public sideLength:number=2){
      super(colour )
      this.colour=colour
      this.type="Square"
   }
   Area(){
      return `Area of a square is: ${this.sideLength * this.sideLength}`
   }
...
class Rectangle extends Shape{
   ...
   constructor(colour:string,public width:number,public height:number){
      super(colour)
      this.colour=colour
      this.width=width
      this.height=height
   ...
   Area(){
      return `Area of a rectangle is: ${this.width * this.height}`
   }
